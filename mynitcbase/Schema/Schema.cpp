...
int Schema::createRel(char relName[],int nAttrs, char attrs[][ATTR_SIZE],int attrtype[]){
    ...
    targetRelId=BlockAccess::linearSearch(RELCAT_RELID,rName,relNameAsAttribute,0);
    ...
    for(int i=0;i<nAttrs;i++){
        ...
        int rett=BlockAccess::insert(ATTRCAT_RELID,attrCatRecord);
...
int Schema::dropIndex(char *relName, char *attrName) {
    ...
    int rootBlock = /* get the root block from attrcat entry */attrCatEntry.rootBlock;
